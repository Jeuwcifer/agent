...
def process_file(filepath):
    ...
    with ThreadPoolExecutor(max_workers=20) as executor:
        ...
        for future in tqdm(as_completed(futures), total=len(strings_data), desc="Pass 1 (Swedish Anchor)", leave=False):
            pass
    ...
    with ThreadPoolExecutor(max_workers=20) as executor:
        ...
        for future in tqdm(as_completed(futures), total=len(strings_data), desc="Pass 2 (French & German)", leave=False):
            pass
